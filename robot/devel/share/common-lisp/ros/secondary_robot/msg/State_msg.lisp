...
(cl:defmethod cl:initialize-instance :after ((m <State_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'State_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name secondary_robot-msg:<State_msg> is deprecated: use secondary_robot-msg:State_msg instead.")))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <State_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader secondary_robot-msg:index-val is deprecated.  Use secondary_robot-msg:index instead.")
  (index m))

(cl:ensure-generic-function 'ready-val :lambda-list '(m))
(cl:defmethod ready-val ((m <State_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader secondary_robot-msg:ready-val is deprecated.  Use secondary_robot-msg:ready instead.")
  (ready m))
