...
(cl:defclass <Command_classes> (roslisp-msg-protocol:ros-message)
  ((action
    :reader action
    :initarg :action
    :type cl:string
...
(cl:defclass Command_classes (<Command_classes>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Command_classes>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Command_classes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbot_mini-msg:<Command_classes> is deprecated: use jetbot_mini-msg:Command_classes instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <Command_classes>))
...
(cl:defmethod subject-val ((m <Command_classes>))
...
(cl:defmethod value-val ((m <Command_classes>))
...
(cl:defmethod unit-val ((m <Command_classes>))
  ...
  (unit m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Command_classes>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Command_classes>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Command_classes>)))
  "Returns string type for a message object of type '<Command_classes>"
  "jetbot_mini/Command_classes")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Command_classes)))
  "Returns string type for a message object of type 'Command_classes"
  "jetbot_mini/Command_classes")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Command_classes>)))
  "Returns md5sum for a message object of type '<Command_classes>"
  "06f8489ff1e7fcaba60778ad9099d7c2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Command_classes)))
  "Returns md5sum for a message object of type 'Command_classes"
  "06f8489ff1e7fcaba60778ad9099d7c2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Command_classes>)))
  "Returns full string definition for message of type '<Command_classes>"
  (cl:format cl:nil "string action~%string subject~%string value~%string unit~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Command_classes)))
  "Returns full string definition for message of type 'Command_classes"
  (cl:format cl:nil "string action~%string subject~%string value~%string unit~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Command_classes>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Command_classes>))
  "Converts a ROS message object to a list"
  (cl:list 'Command_classes
