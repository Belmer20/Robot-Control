...
# You may need to adjust imports and implementations of some functions, as there's no direct TensorFlow equivalent for them.
...
class Jester(tf.keras.utils.Sequence):
    """
    Args:
